...
4. В настройках проекта diplom/diplom/settings.py указать свою временную зону. Взять можно [здесь][https://en.wikipedia.org/wiki/List_of_tz_database_time_zones][] 
